...
const AllLocationsCopyPage: React.FC<PageProps> = () => {
  ...
  return (
    <Layout>
      <Section>
        <Container>
          <States title="What state do you live in?" description="" />
        </Container>
      </Section>
      <Section>
        <Container>
...
export default AllLocationsCopyPage;

export const Head: HeadFC = () => {
  const seoData = {
    title: "Kip | All Locations",
    og_title: "Kio | All Locations",
  };
