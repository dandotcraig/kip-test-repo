...
function ThankYouNSWTrainingPage() {
...
export default ThankYouNSWTrainingPage;
export const Head: HeadFC = () => {
  const seoData = {
    title: "Thank You NSW Training - Kip Kip",
    description: "",
    og_title: "Thank You NSW Training - Kip Kip",
    og_description: "",
    canonical: "https://kip.com.au/thank-you-nsw-training/",
  };
